      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center">
            I Failed (a Lot)—So You Don't Have To
          </h2>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 mb-16">
            ...
            >
              <img 
                ...
                className="rounded-2xl shadow-lg mx-auto md:mx-0 max-w-full md:max-w-[500px] w-full h-auto"
              />
            </motion.div>
            ...
            >
              <div className="text-lg text-gray-700 dark:text-gray-300 space-y-4">
                <p>
                  I'm Jan, founder of DoneResults. I originally built this cold email system for my own video marketing agency.
                </p>
                <p>
